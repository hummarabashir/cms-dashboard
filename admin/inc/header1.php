...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <!--   <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
          <a class="nav-link" href="tables.php">
            ...
            <span class="nav-link-text"> User Tables</span>
          </a>
        </li> -->
        ...
        ?>
         <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
          ...
          <ul class="sidenav-second-level collapse" id="collapseExamplePages2">
            ...
            <li>
              <a href="tables.php">View Users</a>
            </li>
            <li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
         ...
         <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages1">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseExamplePages1" data-parent="#exampleAccordion1">
            <i class="fa fa-fw fa-file"></i>
            <span class="nav-link-text">Blog</span>
          </a>
          <ul class="sidenav-second-level collapse" id="collapseExamplePages1">
            <li>
              <a href="categories.php">Create Categories</a>
            </li>
            <li>
        ...
        ?>
            ...
            ?>
            <li>
              <a href="viewpost.php">Show Blogs</a>
            </li>
            <li>
              <a href="blogedit.php">Edit Blogs</a>
            </li>
            <li>
 ...
 <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages1">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseExamplePages4" data-parent="#exampleAccordion4">
            <i class="fa fa-fw fa-file"></i>
            <span class="nav-link-text">Shopping Cart</span>
          </a>
          <ul class="sidenav-second-level collapse" id="collapseExamplePages4">
            <li>
              <a href="pcategory.php">Create Categories</a>
            </li>
            <li>
            ...
            <li>
              <a href="display.php">Show Products</a>
            </li>
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <a class="nav-link" data-toggle="modal" data-target="">
            <i class="fa fa-fw fa-address-book"></i> <?php echo $login_session;?></a>
        </li>
