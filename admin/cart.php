...
<div>
					...
					<tbody>
						...
						<!-- 	<td class="cart_product">
							...
							<td class="cart_quantity">
								...
								<input type="text" class="quant" name="quantity[]" size="6" value="<?php echo $values['quantity']; ?>">
							...
							<td class="cart_total">
								...
								<!-- <input type="text" hidden name="amount" id="amount" class="amount"> -->
    ...
    <tr>
      ...
      <input type="text" hidden name="total" id="total" class="total">
