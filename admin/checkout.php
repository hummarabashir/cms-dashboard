...
// if (!isset($_SESSION)) {
// }
  if (($_SESSION['login_user'] == '') || (!isset($_SESSION['login_user']))) {
		...
		<!-- 	<div class="breadcrumbs">
			...
			<div class="checkout-options">
				...
				<ul class="nav">
					...
					<li>
						<a href="checkout1.php">Guest Checkout</a>
			...
			<div class="shopper-informations">
				...
				<input type="text" hidden name="userid" value="<?php echo $login_userid;  ?>">
								<input type="text" placeholder="User Name" name="username" value="<?php echo $login_session; ?>">
								<input type="password" placeholder="Password" name="userpassword" value="<?php echo $login_password; ?>">
								<input type="email" placeholder="Email Address" name="useremail" value="<?php echo $login_email; ?>">
